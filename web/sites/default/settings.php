 ...
 * @endcode
 */
$settings['hash_salt'] = 'TJymQiQPwYwCeE7mb_BUQzqpMLWAjOnuCiLL5c41jPVsNYAWpVEYvTUDtdsLTLsX5b912-l5qw';
 ...
 */
$settings['reverse_proxy_addresses'] = ['172.16.0.0/12', '10.0.0.0/8', '192.168.0.0/16'];
...
$databases['default']['default'] = array (
  'database' => getenv('DB_NAME') ?: 'kmdevcoz_drupal',
  'username' => getenv('DB_USER') ?: 'kmdevcoz_drupal',
  'password' => getenv('DB_PASSWORD') ?: 'rootpassword',
  'host' => getenv('DB_HOST') ?: '102.218.215.66',
...
$settings['config_sync_directory'] = 'sites/default/files/config_AaWp3SdDgSu6duO2Y-sy901aoavYiNZrWn2h6aU8eOYGJjsemi8DiMb3jwQwAfz9rNqcEnqDnw/sync';
