 ...
 * @endcode
 */
$settings['hash_salt'] = 'uS87AMDWScWXq6sqBORtcKls6BnFi-dIZupinooFYb5ifVDRuujM74CaJUMChyyN7ILlNPTN3A';
 ...
 * - Overriding database configuration for Docker/MySQL.
 *
 ...
 * 
 * Default SQLite configuration. This is only used if settings.local.php
 * doesn't exist (i.e., not running in Docker).
 */
...
$settings['config_sync_directory'] = 'sites/default/files/config_uRCQiKWEFkYybcy2Bgw0peb35oc9neObJWRuc-p-G2jc42SVglmLiYo3S09uh5IBOGIEsCAEYQ/sync';
